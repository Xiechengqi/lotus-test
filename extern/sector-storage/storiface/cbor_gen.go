...
func (t *StorageInfo) MarshalCBOR(w io.Writer) error {
	...
	// URLs
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajArray, uint64(len(t.URLs))); err != nil {
		return err
	}
	for _, url := range t.URLs {
		if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len(url))); err != nil {
			return err
		}
	...
	// Weight
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, t.Weight); err != nil {
		return err
	}
	// MaxStorage
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, t.MaxStorage); err != nil {
		return err
	}
	if err := cbg.WriteBool(w, t.CanSeal); err != nil {
		return err
	}
	if err := cbg.WriteBool(w, t.CanStore); err != nil {
		return err
	}
...
func (t *StorageInfo) UnmarshalCBOR(r io.Reader) error {
	*t = StorageInfo{}
	...
	// ID
	storageId, _ := cbg.ReadStringBuf(br, scratch)
	t.ID = ID(storageId)
	...
	for i := 0; i < int(extra); i++ {
		url, _ := cbg.ReadStringBuf(br, scratch)
		t.URLs[i] = url
	}
